...
| `dopant_frac` | 0.00–0.30      | Quadratic peaking near 0.27 (saturation) |
| `Li_excess`   | 0.00–0.25      | Quadratic peaking near 0.24 (volatilization compensation) |
...
- Random Forest Regressor ('n_estimators=400', 'random_state=42')
